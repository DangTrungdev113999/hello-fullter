...
abstract class Class with HandleNumberOfSection {
  ...
  set setNumberOfSessions(int newNumberOfSessions) {
    if (newNumberOfSessions < 10) {
      _numberOfSessions = 10;
    } else {
      _numberOfSessions = newNumberOfSessions;
    }
  }
